...
//$cfg['Servers'][$i]['host']          = 'http://160fall2011sec2group2.cs-sjsu.org/phpmyadmin/'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'cssjsuor_160s2g3';      // MySQL user
$cfg['Servers'][$i]['password']      = 'hNu4e3&2';          // MySQL password (only needed
